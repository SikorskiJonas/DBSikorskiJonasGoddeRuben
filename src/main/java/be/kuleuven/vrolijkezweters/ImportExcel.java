            ...
            if (Objects.equals(choice, "Wedstrijd")) {
                try {
                    ...
                    if (inputChecker.checkInput(wedstrijd).isEmpty()) {
                        ...
                        showAlert("Error", "Er zit een fout in de inputgegevens");
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
                ...
                try {
                    ...
                    if (inputChecker.checkInput(etappe).isEmpty()) {
                        etappeDao.insert(etappe);
                    } else {
                        showAlert("Error", "Er zit een fout in de inputgegevens");
                    }
                } catch (Exception e) {
                ...
                System.out.println("couldn't find model to import");
            }
        }
    }
